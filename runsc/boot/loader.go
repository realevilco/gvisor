...
func (l *Loader) run() error {
	...
	var ttyFileVFS2 *hostvfs2.TtyFD
	if !l.restore {
...
func (l *Loader) ttyFromIDLocked(key execID) (*host.TTYFileOperations, *hostvfs2.TtyFD, error) {
	ep := l.processes[key]
	if ep == nil {
...
func createFDTable(ctx context.Context, console bool, stdioFDs []int) (*kernel.FDTable, *host.TTYFileOperations, *hostvfs2.TtyFD, error) {
	if len(stdioFDs) != 3 {
