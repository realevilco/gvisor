...
func Import(ctx context.Context, fdTable *kernel.FDTable, console bool, fds []int) (*host.TTYFileOperations, *hostvfs2.TtyFD, error) {
...
func importVFS2(ctx context.Context, fdTable *kernel.FDTable, console bool, stdioFDs []int) (*hostvfs2.TtyFD, error) {
	...
	return ttyFile.Impl().(*hostvfs2.TtyFD), nil
}
